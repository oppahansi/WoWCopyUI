    ...
    class SetupUITemplateTask extends Task {
        ...
        private boolean copyFiles() {
            try {
                ...
                File accountFolder = new File(Utils.destinationFolder.getAbsolutePath() + "\\" + accName);
                ...
                File realmFolder = new File(accountFolder.getAbsolutePath() + "\\" + realmName);
                if (!realmFolder.exists())
                    if (!realmFolder.mkdir()) return false;

                File charFolder = new File(realmFolder.getAbsolutePath() + "\\" + charName);
                ...
                File templateCharFolder = new File(Utils.sourceFolder.getAbsolutePath() + "\\" + Utils.templateRealmName+ "\\" + Utils.templateCharName);
        ...
        private boolean renameVariables() {
            ...
            File newAccountFolder = new File(Utils.destinationFolder.getAbsolutePath() + "\\" + accName);
            ...
            File charFolder = new File(newAccountFolder.getAbsolutePath() + "\\" + realmName + "\\" + charName);
            if (!charFolder.exists())
                return false;
